...
GO
ALTER TABLE [dbo].[a24] ADD CONSTRAINT [a24_rowid_ix1] PRIMARY KEY NONCLUSTERED ([OBJECTID], [SDE_STATE_ID]) WITH (FILLFACTOR=100) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [a24_state_ix2] ON [dbo].[a24] ([SDE_STATE_ID]) WITH (FILLFACTOR=100) ON [PRIMARY]
GO
